...
<input type="text" name="title" id="title" placeholder="New Title" class="block w-3/5  px-3 py-2 placeholder-gray-300 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-100 focus:border-indigo-300 focus:border-4 dark:bg-gray-700 dark:text-white dark:placeholder-gray-500 dark:border-gray-600 dark:focus:ring-gray-900 dark:focus:border-gray-500" value="{{$post->title}}" />
@error('title')
...
<input type="text" name="verse" id="verse" placeholder="New Verse" class="block w-3/5  px-3 py-2 placeholder-gray-300 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-100 focus:border-indigo-300 focus:border-4 dark:bg-gray-700 dark:text-white dark:placeholder-gray-500 dark:border-gray-600 dark:focus:ring-gray-900 dark:focus:border-gray-500" value="{{$post->verse}}" />
@error('verse')
<span class="text-red-600 font-semibold text-sm">{{$message}}</span>
@enderror
...
<textarea name="body" id="editor" placeholder="write Blog" class="w-3/5  px-3 py-2 placeholder-gray-300 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-100 focus:border-indigo-300 focus:border-4 dark:bg-gray-700 dark:text-white dark:placeholder-gray-500 dark:border-gray-600 dark:focus:ring-gray-900 dark:focus:border-gray-500" style="height: 140px;" >{{$post->body}} </textarea>
@error('body')
<span class="text-red-600 font-semibold text-sm">{{$message}}</span>
@enderror
</div>
