...
<div class="relative px-2 block" x-data="{ isOpen: false }">
                ...
                <button @click="isOpen = !isOpen" class="w-10 h-10 p-1 border-4 border-blue-500 rounded-full focus:outline-none focus:ring">
        <img src="{{$author->avatar}}" class="w-full h-full bg-white flex flex-shrink-0 rounded-full border border-8 border-gray-200">
                </button>
